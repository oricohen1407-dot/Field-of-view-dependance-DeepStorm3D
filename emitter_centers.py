...
OFFAXIS_ZSTACK_FILES = [
    # str(PROJECT_DIR / ZSTACK_FILES_PATH / "center_x477_y573_2um.tif"),
    ...
    # str(PROJECT_DIR / ZSTACK_FILES_PATH / "centerRight_x710_y618.tif"),  #around the centers
    str(PROJECT_DIR / ZSTACK_FILES_PATH / "centerTop_x582_y358.tif"),
    # str(PROJECT_DIR / ZSTACK_FILES_PATH / "centerBottomRight_x670_y780.tif"),
